...
public class LogMenssageXml implements LogMessageImpressao {

	@Override
	public void generateFileLog(LogMessage mensage) {
		String pathArquivo = "/home/luziana/Documents/Padroes_de_projetos/factoryMethod/src/main/java/com/algaworks/factoryMethod/arquivos/logMessage.xml"; 
		try {
